...
folha <- read_html("scrapedpage2.html")
...
download.file(url, destfile = "scrapedpage3.html", quiet=TRUE)
valor <- read_html("scrapedpage3.html")
...
docs <- tm_map(docs, removeWords, c("para", "com", "que")) 
# Remove punctuations
